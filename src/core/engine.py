...
class DigitalTwinEnv:
    ...
    def __init__(self, twin_id, eval_only=False):
        ...
        if eval_only:
            ...
            print(f"[{twin_id}] EVAL MODE - Neutral physics: Gravity=9.8, CartMass=1.0, PoleMass=0.1, Length=0.5")
        else:
            ...
            print(f"[{twin_id}] TRAIN MODE - Moderate physics (±15%): Gravity={self.env.unwrapped.gravity:.2f}, "
