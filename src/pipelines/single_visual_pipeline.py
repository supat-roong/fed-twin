...
def eval_step(
    ...
    loss_neg, num_samples, results = client.evaluate(params, {"server_round": round_num, "eval_episodes": eval_episodes})
...
def single_twin_visual_pipeline(
    ...
    fl_rounds_static = int(fl_rounds) if isinstance(fl_rounds, (int, float)) else config.get("fl_rounds", 10)
...
if __name__ == "__main__":
    compiler.Compiler().compile(single_twin_visual_pipeline, "pipeline_specs/single_visual_pipeline.yaml")
