...
def test_fetch_results_no_artifacts_found(mock_file, mock_remove, mock_exists, mock_boto3):
    mock_s3 = mock_boto3.return_value
    mock_bucket = mock_s3.Bucket.return_value
...
def test_fetch_results_other_csv(mock_remove, mock_exists, mock_boto3):
    ...
    mock_bucket.download_file.assert_called_with("artifacts/run-123/other.csv", "other.csv")
